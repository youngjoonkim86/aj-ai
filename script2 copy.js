...
function getAIResponse(message) {
    const responses = {
        '챗봇은 많이 들어봤지만, 정확히 어떤 서비스 인가요?' : '챗봇은 문자나 음성을 통해 사용자와 소통하는 AI 도구입니다. 자연어 처리(NLP) 기술을 활용해 사용자의 질문을 이해하고 적절한 답변을 제공합니다. 언제 어디서나 문제를 해결하고, 정보를 제공하며, 다양한 작업을 도와줄 수 있습니다. 이러한 점을 바탕으로 AI 정비 챗봇을 개발하게 되었으며, 현재 도요타 모델인 7FB와 7FBR의 매뉴얼을 학습하고 있습니다. 표준화된 용어사전을 기반으로 일관된 답변을 제공할 수 있도록 준비 중입니다.',
        ...
        'AI 정비 챗봇은 어떻게 사용하나요? 예시를 들어주실 수 있나요?': `
            <div>
                ...
                <img src="img/ai-example.png" alt="AI 응답 예시" style="width: 100%; margin-top: 10px;">
            </div>
        `
    };
