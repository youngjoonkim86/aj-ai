...
function getAIResponse(message) {
    const responses = {
        ...
        'AI 정비 챗봇은 어떤 기술로 작동하나요?': '<b>자연어 처리(NLP)</b>와 <b>기계 학습(ML)</b>을 통해 사용자의 질문을 이해하고 답변을 제공합니다.<br/>기본적으로 글(text)로 질문하고 글(text)로 답변하지만, <b>현장 상황</b>과 <b>엔지니어의 니즈</b>를 반영하여 질문 양식을 미리 만들어 놓거나 몇 번의 클릭만으로 질문을 완성할 수 있도록 <b>편의성을 높일 예정</b>입니다.',
        '초보 엔지니어도 AI 정비 챗봇을 사용할 수 있나요?': '<p>네, 간단한 인터페이스 덕분에 <b>초보자도 쉽게 사용</b>할 수 있습니다.</p><br/> AI 정비 챗봇은 궁금한 내용에 대하여 컴퓨터가 정확하게 인지할 수 있도록 질문을 해야합니다. 따라서 궁금한 장비의 모델이나 에러코드 등을 특정하여 질문한다면 초보자도 쉽게 사용하실 수 있습니다. 구축 단계에서 편리하고 정확한 질문을 할 수 있도록 <b>질문 양식을 규격화하여 편의 기능으로 제공 예정</b>입니다.',
        ...
        'AI 정비 챗봇이 엔지니어의 역할을 대체할 수 있나요?': '아니요, AI는 엔지니어를 <b>보조하는 도구</b>로 설계되었습니다.<br/>엔지니어의 <b>비서 역할</b>로 활약이 기대됩니다. 귀찮게 생각되었던 매뉴얼을 찾아보고 부품번호가 나와있는 카탈로그의 페이지를 찾는 행위를 도와주는 역할입니다.',
...
const questionData = {
    operational1: [
        ...
        '초보 엔지니어도 AI 정비 챗봇을 사용할 수 있나요?',
        'AI 정비 챗봇은 데이터를 어떻게 업데이트하나요?',
        'AI 정비 챗봇이 엔지니어의 역할을 대체할 수 있나요?'
    ],
    operational2: [
